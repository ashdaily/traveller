<div class='container-fluid home-0'>
    ...
    <div class='col-xs-12 col-sm-10 col-sm-offset-1 col-md-10 col-md-offset-1 col-lg-10 col-lg-offset-1 home-2'>
        <ul class="nav nav-pills nav-justified">
            ...
            <!--            <li class="active"><a data-toggle="tab" href="#home">FLIGHT</a></li>
                    ...
                    <form class='form-group'>
                        <div class='col-xs-12 input-field'>
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" placeholder="Search Holiday Packages" aria-describedby="basic-addon1" name='from'>
                            </div>

                        </div>

                        <div class='col-xs-10 col-xs-offset-1 col-md-4 col-md-offset-8'>
                            <button class='btn btn-default'><i class='fa fa-rocket'></i> Search Package</button>
                        </div>
                    </form>
            ...
            <!--            <div id="home" class="tab-pane fade in active">
                            <div class='col-xs-12 col-md-10 col-md-offset-1 flight-form'>
                                <form class='form-group'>
                                    ...
                                    <div class='col-xs-10 col-xs-offset-1 col-md-4 col-md-offset-8'>
                                        <button class='btn btn-default'><i class='fa fa-rocket'></i> Cheap Fares</button>
                                    </div>
                                </form>
                            </div>
                        </div>
