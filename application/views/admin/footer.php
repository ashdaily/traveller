...
<script src="<?= base_url() ?>assets/js/toastr.js" id="script-resource-15"></script>
<script src="<?= base_url() ?>assets/js/fileinput.js" id="script-resource-8"></script>
...
<!-- Demo Settings -->
<script src="<?= base_url() ?>assets/js/neon-demo.js" id="script-resource-18"></script>
<script src="<?= base_url() ?>assets/js/neon-skins.js" id="script-resource-19"></script>
